            ...
            <div class="card-header py-3">
                <div class="form-inline">
                    ...
                    <span class="ml-auto no-print">
                        ...
                        <a href="index.php?page=TambahRuang" class="btn btn-primary btn-sm">Tambah Data</a>
                    </span>
                </div>
            </div>
            <div class="card-body">
                            ...
                            while ($ruang = mysqli_fetch_assoc($result)) {
                                if ($ruang['id_ruang'] != 1) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?page=UbahRuang&id=<?php echo $ruang['id_ruang'] ?>" class="btn btn-info btn-sm">Ubah</a>
                                        </td>
                                    </tr>
                                <?php
                            }
